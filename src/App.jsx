...
function App() {
  ...
  const characters = [
    { name: "Wally", image: '/images/wally.jpg'},
    { name: "Woof", image: '/images/woof.jpg'},
    { name: "Wizard", image: '/images/wizard.jpg'},
    { name: "Odlaw", image: '/images/odlaw.jpg'},
    { name: "Wenda", image: '/images/wenda.jpg'}
  ]

//! SET UP REACT ROUTER, move this to home.jsx
    ...
    <>
      ...
      { position.x && position.y && (
        ...
        ></div>
          ...
          {showModal &&  <Modal  top={position.y} left={position.x} characters={characters} />}
        </div>
